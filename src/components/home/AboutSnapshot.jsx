    ...
    <section className="section-py bg-sand">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          {/* Left — text */}
          <div ref={leftRef}>
            <h2 className="font-serif text-forest mb-6">
              A different kind of enterprise partner.
            </h2>
            <div className="flex flex-col gap-5">
              <p className="font-sans text-ink-mid text-[1.0625rem] leading-relaxed">
            ...
            <div className="mt-8">
              <Link
                to="/contact"
                className="font-sans font-semibold text-sm transition-colors duration-200 text-clay hover:text-clay-dark"
              >
                Work with us →
              </Link>
            </div>
